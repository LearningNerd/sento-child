...
//			),
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'     => array(
			...
			array(
				'title'                      => __('Enable Social Media Links (Main Header)', 'redux-framework'), 
				$thinkup_subtitle_panel      => __('Switch on to enable links to social media pages.', 'redux-framework'),
				$thinkup_subtitle_customizer => __('Switch on to enable links to social media pages.', 'redux-framework'),
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'     => array(
			...
			array(
				'title'                      => __('Blog Links', 'redux-framework'),
				$thinkup_subtitle_panel      => __('Choose which links to show on the post hover.', 'redux-framework'),
				$thinkup_subtitle_customizer => __('Choose which links to show on the post hover.', 'redux-framework'),
				'id'                         => 'thinkup_blog_hovercheck',
				'type'                       => 'checkbox',
				'options'                    => array(
					'option1' => 'Check to show lightbox link',
					'option2' => 'Check to show post link',
				),
			),
    ...
    Redux::setSection( $opt_name, array(
		'title'      => __('Support', 'redux-framework'),
		'desc'       => __('For premium support direct from the theme developers, or advice on customizations please <a href="http://www.thinkupthemes.com/themes/sento/" target="_blank">upgrade</a> to Sento Pro or purchase a <a href="http://www.thinkupthemes.com/pricing/" target="_blank">Theme Subscription</a>.', 'redux-framework'),
		'icon'       => 'el el-user',
		'icon_class' => '',
    ...
    Redux::setSection( $opt_name, array(
		...
		'fields'     => array(
			...
			array(
				...
				'upgrade_url' => '//www.thinkupthemes.com/themes/sento/',
			),
		)
	) );
