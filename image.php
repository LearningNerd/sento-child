					...
					<header class="entry-header">
						<div class="entry-meta">
							<?php
								...
								printf( __( 'Published ', 'sento') . '<span><time datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="' . __( 'Link to full-size image', 'sento') . '">%4$s &times; %5$s</a> in <a href="%6$s" title="' . __( 'Return to ', 'sento') . '%7$s" rel="gallery">%8$s</a>',
